...
const products = [
  { sku: 'DRK-SOD-001', barcode: '0490112340017', title: 'Cascade Springs Cola', brand: 'Cascade Springs', departmentSlug: 'drinks', categorySlug: 'soft-drinks', unit: '20 fl oz bottle', price: 2.29, listPrice: 2.79, stock: 240, lowStockAt: 48, art: 'soda', hue: 205, tags: ['cold', 'single-serve'], bullets: ['Classic cola, cane sugar sweetened', 'Sold cold from the front cooler', '20 fl oz resealable bottle', 'Caffeine 57mg per bottle'], description: 'The everyday cola, pulled straight from the cooler. Cane sugar rather than corn syrup, and the cap reseals so it survives the rest of the drive.' },
  { sku: 'DRK-ENG-002', barcode: '0490112340024', title: 'Voltix Energy Drink — Citrus Surge', brand: 'Voltix', departmentSlug: 'drinks', categorySlug: 'energy-drinks', unit: '16 fl oz can', price: 3.49, listPrice: 4.29, stock: 156, lowStockAt: 36, art: 'energy', hue: 265, tags: ['cold', 'caffeine'], bullets: ['200mg caffeine plus B-vitamin blend', 'Zero sugar, 10 calories', 'Citrus flavour with no aftertaste', 'Chilled and ready to drink'], description: 'A zero-sugar energy can that does not taste like cough syrup. 200mg of caffeine puts it around two strong coffees, so treat it accordingly on a long haul.' },
  { sku: 'DRK-WTR-003', barcode: '0490112340031', title: 'Cascade Springs Purified Water 6-Pack', brand: 'Cascade Springs', departmentSlug: 'drinks', categorySlug: 'water', unit: '6 × 16.9 fl oz', price: 4.99, stock: 88, lowStockAt: 24, art: 'water', hue: 195, tags: ['multipack'], bullets: ['Reverse-osmosis purified, mineral balanced', 'Six 16.9 fl oz bottles', '100% recycled PET bottles', 'Shelf stable — no refrigeration needed'], description: 'Six bottles in a carry pack. Purified by reverse osmosis then remineralised, so it does not have the flat taste distilled water gets.' },
  { sku: 'DRK-COF-004', barcode: '0490112340048', title: 'RoastWorks Fresh Brew Coffee — Large', brand: 'RoastWorks', departmentSlug: 'drinks', categorySlug: 'coffee-tea', unit: '20 fl oz cup', price: 2.49, stock: 999, lowStockAt: 0, art: 'coffee', hue: 25, tags: ['hot', 'made-to-order'], bullets: ['Brewed fresh every 30 minutes', 'Medium roast, 100% arabica', 'Free refills on the same visit', 'Cream, sugar and syrups at the counter'], description: 'Brewed on a 30-minute cycle so it is never sitting on a hot plate going bitter. Medium roast arabica, and refills are free if you come back with the cup.' },
  { sku: 'DRK-JCE-005', barcode: '0490112340055', title: 'Orchard Lane Orange Juice', brand: 'Orchard Lane', departmentSlug: 'drinks', categorySlug: 'juice', unit: '15.2 fl oz', price: 3.19, stock: 64, lowStockAt: 18, art: 'juice', hue: 35, tags: ['cold', 'chilled'], bullets: ['Not from concentrate', 'No added sugar', 'Pasteurised, keep refrigerated', 'One full serving of fruit'], description: 'Not-from-concentrate orange juice kept in the cold case. No added sugar, so it tastes like oranges rather than orange candy.' },
  { sku: 'SNK-CHP-006', barcode: '0490112340062', title: 'Crisp County Kettle Chips — Sea Salt', brand: 'Crisp County', departmentSlug: 'snacks', categorySlug: 'chips', unit: '8 oz bag', price: 3.99, listPrice: 4.99, stock: 132, lowStockAt: 30, art: 'chips', hue: 45, tags: ['sharing'], bullets: ['Kettle cooked in small batches', 'Just potatoes, oil and sea salt', '8 oz sharing bag', 'No artificial flavours or colours'], description: 'Kettle cooked so they actually crunch instead of shattering. Three ingredients on the back of the bag, which is rare for a crisp.' },
  { sku: 'SNK-CND-007', barcode: '0490112340079', title: 'SweetPeak Milk Chocolate Bar', brand: 'SweetPeak', departmentSlug: 'snacks', categorySlug: 'candy', unit: '1.55 oz bar', price: 1.89, stock: 310, lowStockAt: 60, art: 'chocolate', hue: 20, tags: ['impulse', 'checkout'], bullets: ['32% cocoa milk chocolate', 'Rainforest Alliance certified cocoa', 'Classic 1.55 oz bar', 'Also sold in king size'], description: 'The standard checkout chocolate bar, made with certified cocoa. Melts properly rather than going waxy, which is the giveaway on cheap compound chocolate.' },
  { sku: 'SNK-JRK-008', barcode: '0490112340086', title: 'Trailhead Beef Jerky — Original', brand: 'Trailhead', departmentSlug: 'snacks', categorySlug: 'nuts-jerky', unit: '3.25 oz bag', price: 7.49, listPrice: 8.99, stock: 74, lowStockAt: 20, art: 'jerky', hue: 20, tags: ['protein', 'road-trip'], bullets: ['11g protein per serving', 'No added nitrates or MSG', 'Slow marinated for 12 hours', 'Resealable 3.25 oz bag'], description: 'Actually tender jerky rather than the shoe-leather kind. Marinated overnight before smoking, with no nitrates added.' },
  { sku: 'SNK-NUT-009', barcode: '0490112340093', title: 'Trailhead Roasted Mixed Nuts', brand: 'Trailhead', departmentSlug: 'snacks', categorySlug: 'nuts-jerky', unit: '6 oz canister', price: 5.99, stock: 96, lowStockAt: 24, art: 'nuts', hue: 30, tags: ['protein'], bullets: ['Almonds, cashews, pecans and hazelnuts', 'Dry roasted with sea salt', 'Resealable canister', 'Good source of protein and fibre'], description: 'Dry roasted rather than oil roasted, so they are not greasy in the cupholder. The canister reseals, which a bag never really does.' },
  { sku: 'SNK-GUM-010', barcode: '0490112340109', title: 'FreshBake Spearmint Gum', brand: 'SweetPeak', departmentSlug: 'snacks', categorySlug: 'gum-mints', unit: '15-stick pack', price: 1.49, stock: 420, lowStockAt: 80, art: 'gum', hue: 175, tags: ['impulse', 'checkout'], bullets: ['Sugar free, sweetened with xylitol', '15 sticks per pack', 'Long-lasting spearmint', 'Helps neutralise mouth acid'], description: 'Sugar-free spearmint that keeps its flavour past the first minute. Fifteen sticks in a slim pack that fits a shirt pocket.' },
  { sku: 'BAK-DNT-011', barcode: '0490112340116', title: 'FreshBake Glazed Donut', brand: 'FreshBake', departmentSlug: 'bakery', categorySlug: 'fresh-bakery', unit: 'each', price: 1.29, stock: 9, lowStockAt: 12, art: 'donut', hue: 25, tags: ['fresh-daily', 'hot'], bullets: ['Baked fresh on site each morning', 'Classic sugar glaze', 'Buy 6 and get the 7th free', 'Best eaten same day'], description: 'Made on site before opening, not shipped in frozen. Sells out most mornings by nine, which tells you what you need to know.' },
  { sku: 'BAK-SND-012', barcode: '0490112340123', title: 'HotStop Breakfast Sandwich — Egg & Cheese', brand: 'HotStop', departmentSlug: 'bakery', categorySlug: 'hot-food', unit: 'each', price: 4.49, listPrice: 5.49, stock: 6, lowStockAt: 8, art: 'sandwich', hue: 40, tags: ['hot', 'breakfast'], bullets: ['Cage-free egg with melted cheddar', 'Served on a toasted English muffin', 'Ready hot from 5am to 11am', 'Add bacon or sausage at the counter'], description: 'Hot from five in the morning. Cage-free egg and real cheddar on a toasted muffin — it holds together in one hand while you drive.' },
  { sku: 'BAK-HTD-013', barcode: '0490112340130', title: 'HotStop Roller Grill Hot Dog', brand: 'HotStop', departmentSlug: 'bakery', categorySlug: 'hot-food', unit: 'each', price: 2.99, stock: 34, lowStockAt: 10, art: 'hotdog', hue: 15, tags: ['hot', 'all-day'], bullets: ['All-beef frank', 'Free toppings bar', 'Available all day, every day', 'Two for $5 deal'], description: 'All-beef frank off the roller, with the toppings bar included. Two for five dollars if you are feeding someone else.' },
  { sku: 'BAK-MUF-014', barcode: '0490112340147', title: 'FreshBake Blueberry Muffin', brand: 'FreshBake', departmentSlug: 'bakery', categorySlug: 'fresh-bakery', unit: 'each', price: 2.19, stock: 0, lowStockAt: 10, art: 'muffin', hue: 280, tags: ['fresh-daily'], bullets: ['Real blueberries, not flavoured pieces', 'Baked on site daily', 'Individually wrapped', 'Warms well in 15 seconds'], description: 'Baked on site with real blueberries — you can see them in the crumb. Fifteen seconds in the microwave brings it back to fresh.' },
  { sku: 'GRO-DRY-015', barcode: '0490112340154', title: 'Meadowvale Whole Milk', brand: 'Meadowvale', departmentSlug: 'grocery', categorySlug: 'dairy', unit: '1 gallon', price: 4.29, stock: 42, lowStockAt: 12, art: 'milk', hue: 200, tags: ['chilled', 'essential'], bullets: ['Grade A whole milk', 'From local dairies within 100 miles', 'Keep refrigerated', 'Vitamin D fortified'], description: 'Grade A whole milk from dairies inside a hundred miles, so it arrives with plenty of date left on it.' },
  { sku: 'GRO-DRY-016', barcode: '0490112340161', title: 'Meadowvale Large Eggs', brand: 'Meadowvale', departmentSlug: 'grocery', categorySlug: 'dairy', unit: 'dozen', price: 3.99, listPrice: 4.79, stock: 38, lowStockAt: 12, art: 'eggs', hue: 45, tags: ['chilled', 'essential'], bullets: ['Grade A large, cage-free', 'Dozen in a recycled pulp carton', 'Keep refrigerated', 'Candled and graded on farm'], description: 'Cage-free grade A large eggs in a pulp carton that composts. The one thing everyone forgets until they are already home.' },
  { sku: 'GRO-BRD-017', barcode: '0490112340178', title: 'FreshBake Sliced White Bread', brand: 'FreshBake', departmentSlug: 'grocery', categorySlug: 'pantry', unit: '20 oz loaf', price: 2.99, stock: 56, lowStockAt: 16, art: 'bread', hue: 35, tags: ['essential'], bullets: ['Soft sandwich loaf, 20 slices', 'No high-fructose corn syrup', 'Baked within 24 hours of delivery', 'Freezes well'], description: 'A plain soft sandwich loaf without the corn syrup most cheap bread carries. Twenty slices, so eighteen sandwiches and two heels nobody wants.' },
  { sku: 'GRO-PAN-018', barcode: '0490112340185', title: 'PantryCo Instant Ramen — Chicken', brand: 'PantryCo', departmentSlug: 'grocery', categorySlug: 'pantry', unit: '3 oz cup', price: 1.29, stock: 180, lowStockAt: 40, art: 'soup', hue: 30, tags: ['shelf-stable', 'hot-water'], bullets: ['Ready in 3 minutes with hot water', 'Free hot water at the coffee station', 'Fork included under the lid', 'Shelf stable for 12 months'], description: 'Three minutes and hot water, which we give away free at the coffee station. The fork is under the lid so you are not stuck in the car without one.' },
  { sku: 'GRO-FRZ-019', barcode: '0490112340192', title: 'FrostLine Vanilla Ice Cream Pint', brand: 'FrostLine', departmentSlug: 'grocery', categorySlug: 'frozen', unit: '1 pint', price: 5.49, listPrice: 6.99, stock: 7, lowStockAt: 10, art: 'iceCream', hue: 300, tags: ['frozen'], bullets: ['Made with real vanilla bean', '14% butterfat — a true premium base', 'Pint size', 'Keep frozen'], description: 'Real vanilla bean and a 14% butterfat base, which is what separates premium from the airy stuff. You can see the seeds in it.' },
  { sku: 'AUT-OIL-020', barcode: '0490112340208', title: 'MotorMax Full Synthetic Motor Oil 5W-30', brand: 'MotorMax', departmentSlug: 'automotive', categorySlug: 'fluids', unit: '5 quart jug', price: 27.99, listPrice: 34.99, stock: 22, lowStockAt: 6, art: 'oil', hue: 200, tags: ['bulk'], bullets: ['Full synthetic, API SP rated', 'Protects up to 10,000 miles between changes', 'Suits most petrol engines needing 5W-30', '5 quart jug with a pour spout'], description: 'Full synthetic rated to the current API SP standard, in the five-quart jug that covers most oil changes in one go.' },
  { sku: 'AUT-WIP-021', barcode: '0490112340215', title: 'DriveTech All-Season Wiper Blade 22"', brand: 'DriveTech', departmentSlug: 'automotive', categorySlug: 'car-accessories', unit: 'each', price: 14.99, stock: 5, lowStockAt: 8, art: 'wiper', hue: 210, tags: [], bullets: ['22-inch beam blade, no exposed frame', 'Graphite-coated rubber for quiet wiping', 'Fits most J-hook wiper arms', 'Tool-free install in about a minute'], description: 'A beam-style blade with no frame to pack with ice. Clips onto standard J-hook arms without tools — about a minute a side.' },
  { sku: 'AUT-FLD-022', barcode: '0490112340222', title: 'MotorMax Windshield Washer Fluid', brand: 'MotorMax', departmentSlug: 'automotive', categorySlug: 'fluids', unit: '1 gallon', price: 4.49, stock: 64, lowStockAt: 16, art: 'coolant', hue: 195, tags: [], bullets: ['Effective to -20°F', 'Cuts bug splatter and road film', 'Safe on paint and rubber trim', '1 gallon jug'], description: 'Rated to twenty below, so it will not freeze in the reservoir and split it. Cuts road film without leaving a smear.' },
  { sku: 'AUT-ACC-023', barcode: '0490112340239', title: 'DriveTech 30W USB-C Car Charger', brand: 'DriveTech', departmentSlug: 'automotive', categorySlug: 'car-accessories', unit: 'each', price: 16.99, listPrice: 22.99, stock: 44, lowStockAt: 12, art: 'phoneCharger', hue: 220, tags: ['electronics'], bullets: ['30W USB-C Power Delivery plus 12W USB-A', 'Charges most phones to 50% in 30 minutes', 'Built-in surge protection', 'Fits standard 12V sockets'], description: 'Thirty watts over USB-C, which is enough to fast charge a phone rather than just holding it steady while the map runs.' },
  { sku: 'AUT-ACC-024', barcode: '0490112340246', title: 'DriveTech Air Freshener — Black Ice', brand: 'DriveTech', departmentSlug: 'automotive', categorySlug: 'car-accessories', unit: '3-pack', price: 3.99, stock: 120, lowStockAt: 30, art: 'airFreshener', hue: 250, tags: ['impulse'], bullets: ['Three hanging fresheners per pack', 'Lasts around 30 days each', 'Adjustable-release sleeve', 'Classic cool fragrance'], description: 'Three to a pack with a sleeve you slide down to control how strong it is — pull it all the way out on day one and it is gone in a week.' },
  { sku: 'HOU-CLN-025', barcode: '0490112340253', title: 'PureHome Multi-Surface Cleaner', brand: 'PureHome', departmentSlug: 'household', categorySlug: 'cleaning', unit: '28 fl oz spray', price: 4.79, stock: 58, lowStockAt: 15, art: 'cleaner', hue: 165, tags: [], bullets: ['Safe on sealed counters, glass and stainless', 'Plant-derived surfactants', 'No bleach or ammonia', '28 fl oz trigger spray'], description: 'One bottle for counters, glass and stainless, without the ammonia smell that lingers for an hour afterwards.' },
  { sku: 'HOU-PPR-026', barcode: '0490112340260', title: 'SoftFold Paper Towels 6-Roll', brand: 'SoftFold', departmentSlug: 'household', categorySlug: 'paper-goods', unit: '6 mega rolls', price: 11.99, listPrice: 14.99, stock: 36, lowStockAt: 10, art: 'paperTowel', hue: 150, tags: ['bulk'], bullets: ['Six mega rolls, equal to 15 regular', '2-ply with a select-a-size sheet', 'Strong when wet', 'Made from responsibly sourced fibre'], description: 'Six mega rolls that work out to about fifteen regular ones. Half-sheet perforation means you are not wasting a full sheet on a small spill.' },
  { sku: 'HOU-BAT-027', barcode: '0490112340277', title: 'PowerCell AA Alkaline Batteries 8-Pack', brand: 'PowerCell', departmentSlug: 'household', categorySlug: 'batteries', unit: '8-pack', price: 9.49, stock: 92, lowStockAt: 24, art: 'battery', hue: 55, tags: ['essential'], bullets: ['Eight AA alkaline cells', '10-year shelf life in storage', 'Leak-resistant construction', 'Suits remotes, toys and torches'], description: 'Eight AA cells with a ten-year shelf life, so a spare pack in the drawer will still work when you finally need it.' },
  { sku: 'HOU-DET-028', barcode: '0490112340284', title: 'PureHome Laundry Detergent Pods 20ct', brand: 'PureHome', departmentSlug: 'household', categorySlug: 'cleaning', unit: '20 pods', price: 8.99, stock: 40, lowStockAt: 12, art: 'detergent', hue: 210, tags: [], bullets: ['20 pre-measured pods', 'Works in hot and cold water', 'HE machine compatible', 'Child-resistant tub'], description: 'Pre-measured pods that dissolve in cold water, which most cheap ones do not — you find the shell stuck to a sleeve afterwards.' },
  { sku: 'MED-PAI-029', barcode: '0490112340291', title: 'ReliefRx Ibuprofen 200mg', brand: 'ReliefRx', departmentSlug: 'medicine', categorySlug: 'pain-relief', unit: '24 tablets', price: 6.49, stock: 70, lowStockAt: 18, art: 'pills', hue: 190, tags: ['otc'], bullets: ['200mg ibuprofen per coated tablet', 'For headache, muscle ache and fever', '24 tablets in a sealed bottle', 'Read the label before use'], description: 'Standard 200mg ibuprofen in a 24-count bottle. Coated tablets, which go down easier than the chalky uncoated kind.' },
  { sku: 'MED-FST-030', barcode: '0490112340307', title: 'MediKit Adhesive Bandages Variety Pack', brand: 'MediKit', departmentSlug: 'medicine', categorySlug: 'first-aid', unit: '40 count', price: 4.99, stock: 84, lowStockAt: 20, art: 'bandage', hue: 210, tags: ['otc'], bullets: ['40 bandages across four sizes', 'Flexible fabric that moves with skin', 'Sterile until opened', 'Latex free'], description: 'Forty bandages in four sizes, on flexible fabric rather than plastic so they stay on knuckles and knees.' },
  { sku: 'MED-PER-031', barcode: '0490112340314', title: 'DailyCare Hand Sanitizer Gel', brand: 'DailyCare', departmentSlug: 'medicine', categorySlug: 'personal-care', unit: '8 fl oz', price: 3.49, stock: 110, lowStockAt: 25, art: 'sanitizer', hue: 175, tags: ['otc'], bullets: ['70% ethyl alcohol', 'Kills 99.9% of common germs', 'Aloe and vitamin E to reduce drying', '8 fl oz pump bottle'], description: 'Seventy percent alcohol, which is the level that actually works, with aloe added so your hands are not cracked by Wednesday.' },
  { sku: 'MED-PER-032', barcode: '0490112340321', title: 'DailyCare Travel Toothpaste', brand: 'DailyCare', departmentSlug: 'medicine', categorySlug: 'personal-care', unit: '0.85 oz', price: 2.29, stock: 96, lowStockAt: 24, art: 'toothpaste', hue: 180, tags: ['travel'], bullets: ['Fluoride toothpaste, cavity protection', 'TSA carry-on approved size', 'Fresh mint', '0.85 oz travel tube'], description: 'Carry-on sized fluoride toothpaste for the trip you packed for in a hurry. Fits the liquids bag without argument.' },
  { sku: 'TOB-CIG-033', barcode: '0490112340338', title: 'Summit Original Cigarettes', brand: 'Summit', departmentSlug: 'tobacco', categorySlug: 'cigarettes', unit: 'pack of 20', price: 9.99, stock: 60, lowStockAt: 15, art: 'cigarettes', hue: 15, ageRestricted: true, tags: ['age-restricted', 'id-required'], bullets: ['Pack of 20', 'Photo ID required — 21 and over', 'Not eligible for delivery in all areas', 'Sold from behind the counter'], description: 'Sold from behind the counter. Photo ID is required at handover for anyone appearing under 40, without exception.' },
  { sku: 'TOB-LTR-034', barcode: '0490112340345', title: 'FlameCo Refillable Lighter', brand: 'FlameCo', departmentSlug: 'tobacco', categorySlug: 'lighters', unit: 'each', price: 2.49, stock: 140, lowStockAt: 30, art: 'lighter', hue: 10, ageRestricted: true, tags: ['age-restricted', 'impulse'], bullets: ['Adjustable flame height', 'Refillable with standard butane', 'Child-resistant mechanism', 'Photo ID required — 18 and over'], description: 'Refillable rather than disposable, with an adjustable flame. Child-resistant catch as required by law.' },
  { sku: 'PET-FUD-035', barcode: '0490112340352', title: 'PawPantry Complete Dry Dog Food', brand: 'PawPantry', departmentSlug: 'pet-supplies', categorySlug: 'pet-food', unit: '4 lb bag', price: 12.99, listPrice: 15.99, stock: 26, lowStockAt: 8, art: 'petFood', hue: 100, tags: ['bulk'], bullets: ['Real chicken as the first ingredient', 'Complete and balanced for adult dogs', 'No corn, wheat or soy fillers', '4 lb resealable bag'], description: 'Chicken first on the ingredient list rather than corn, and complete-and-balanced certified for adult dogs. The bag reseals.' },
  { sku: 'PET-TRT-036', barcode: '0490112340369', title: 'PawPantry Dental Chew Treats', brand: 'PawPantry', departmentSlug: 'pet-supplies', categorySlug: 'pet-treats', unit: '12 chews', price: 8.49, stock: 48, lowStockAt: 12, art: 'petTreat', hue: 85, tags: [], bullets: ['Ridged texture helps reduce plaque', '12 chews per pack', 'For dogs over 20 lb', 'No artificial colours'], description: 'Ridged chews that scrape plaque while the dog works on them. Twelve to a pack, sized for dogs over twenty pounds.' },
];
...
async function main() {
  ...
  /*
   * Products upsert by `sku` rather than a hand-assigned id — with ids now
   * auto-incrementing integers assigned by Postgres, `sku` is the only stable
   * key the seed itself controls across repeated runs.
   */
  for (const p of products) {
    await prisma.product.upsert({ where: { sku: p.sku }, update: KEEP_EXISTING, create: p });
  }

  /*
   * Only one store exists today, so "does a store already exist" is enough
   * to make this idempotent without needing a hand-assigned id to upsert by.
   */
  const store =
    ...
    (await prisma.storeLocation.create({
      data: {
        ...
        city: 'Karachi',
        phone: '(555) 018-4420',
        /* The real shopfront. These coordinates decide who may order, so a
           placeholder here silently refuses every genuine customer. */
        lat: 24.811,
        lng: 67.029,
        radiusMiles: 5,
        hours: 'Open 24 hours',
  ...
  /*
   * Promotions. Seeded by title rather than a hand-assigned id — with ids now
   * auto-incrementing, "does a deal with this title already exist" is what
   * keeps re-running the seed from stacking up duplicates. Product skus are
   * filtered against what actually exists, so a deal referencing a product
   * that was removed still seeds — just with a shorter product list.
   */
  const seedDeals = [
    {
      kind: 'flash' as const,
    ...
    },
    {
      ...
      skus: ['SNK-CHP-006', 'SNK-JRK-008', 'SNK-NUT-009'],
      percentOff: 25,
    },
  ];

  for (const { skus, ...deal } of seedDeals) {
    if (await prisma.deal.findFirst({ where: { title: deal.title } })) continue;
    ...
    await prisma.deal.create({ data: { ...deal, products: { connect } } });
  }
  ...
  for (const slide of heroSlides) {
    /*
     * Re-seeding must never clear artwork an admin has uploaded, and with ids
     * now auto-incrementing there is no hand-assigned id to upsert by — so a
     * slide with this title already existing is what makes this create-only
     * step idempotent, same effect as the old KEEP_EXISTING upsert.
     */
    if (await prisma.heroSlide.findFirst({ where: { title: slide.title } })) continue;
  ...
  for (const card of showcaseCards) {
     ...
     * their tiles; only a brand new card gets the seeded ones. Matched by
     * title since ids are now auto-incrementing, not hand-assigned.
     */
    if (await prisma.showcaseCard.findFirst({ where: { title: card.title } })) continue;
    await prisma.showcaseCard.create({ data: card });
  }
