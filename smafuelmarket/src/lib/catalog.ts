...
export const products: Product[] = [
  // ---- Drinks -------------------------------------------------------------
  p({
    id: "gs-1001", sku: "DRK-SOD-001", barcode: "0490112340017",
    ...
    rating: 4.4, reviews: 1820, art: "soda", hue: 205,
  ...
  p({
    id: "gs-1002", sku: "DRK-ENG-002", barcode: "0490112340024",
    ...
    rating: 4.2, reviews: 3410, art: "energy", hue: 265,
    tags: ["cold", "caffeine"],
  ...
  p({
    id: "gs-1003", sku: "DRK-WTR-003", barcode: "0490112340031",
    ...
    rating: 4.7, reviews: 2260, art: "water", hue: 195,
    tags: ["multipack"],
  ...
  p({
    id: "gs-1004", sku: "DRK-COF-004", barcode: "0490112340048",
    ...
    rating: 4.6, reviews: 5140, art: "coffee", hue: 25,
  ...
  p({
    ...
    rating: 4.5, reviews: 940, art: "juice", hue: 35,
    tags: ["cold", "chilled"],
  ...
  // ---- Snacks -------------------------------------------------------------
  p({
    id: "gs-1006", sku: "SNK-CHP-006", barcode: "0490112340062",
    ...
    rating: 4.6, reviews: 2870, art: "chips", hue: 45,
    tags: ["sharing"],
  ...
  p({
    ...
    rating: 4.5, reviews: 4120, art: "chocolate", hue: 20,
  ...
  p({
    id: "gs-1008", sku: "SNK-JRK-008", barcode: "0490112340086",
    ...
    rating: 4.7, reviews: 1980, art: "jerky", hue: 20,
  ...
  p({
    id: "gs-1009", sku: "SNK-NUT-009", barcode: "0490112340093",
    ...
    rating: 4.4, reviews: 1130, art: "nuts", hue: 30,
    tags: ["protein"],
  ...
  p({
    id: "gs-1010", sku: "SNK-GUM-010", barcode: "0490112340109",
    ...
    rating: 4.3, reviews: 760, art: "gum", hue: 175,
    tags: ["impulse", "checkout"],
  ...
  // ---- Bakery -------------------------------------------------------------
  p({
    id: "gs-1011", sku: "BAK-DNT-011", barcode: "0490112340116",
    ...
    rating: 4.6, reviews: 2240, art: "donut", hue: 25,
  ...
  p({
    id: "gs-1012", sku: "BAK-SND-012", barcode: "0490112340123",
    ...
    rating: 4.3, reviews: 1610, art: "sandwich", hue: 40,
    tags: ["hot", "breakfast"],
  ...
  p({
    id: "gs-1013", sku: "BAK-HTD-013", barcode: "0490112340130",
    title: "HotStop Roller Grill Hot Dog", brand: "HotStop",
    department: "bakery", category: "hot-food", unit: "each",
    price: 2.99, stock: 34, lowStockAt: 10,
    rating: 4.1, reviews: 2890, art: "hotdog", hue: 15,
    tags: ["hot", "all-day"],
  ...
  p({
    id: "gs-1014", sku: "BAK-MUF-014", barcode: "0490112340147",
    title: "FreshBake Blueberry Muffin", brand: "FreshBake",
    department: "bakery", category: "fresh-bakery", unit: "each",
    price: 2.19, stock: 0, lowStockAt: 10,
    rating: 4.4, reviews: 870, art: "muffin", hue: 280,
    tags: ["fresh-daily"],
  ...
  // ---- Grocery ------------------------------------------------------------
  p({
    id: "gs-1015", sku: "GRO-DRY-015", barcode: "0490112340154",
    ...
    rating: 4.6, reviews: 1440, art: "milk", hue: 200,
  ...
  p({
    id: "gs-1016", sku: "GRO-DRY-016", barcode: "0490112340161",
    ...
    rating: 4.5, reviews: 1020, art: "eggs", hue: 45,
    tags: ["chilled", "essential"],
  ...
  p({
    id: "gs-1017", sku: "GRO-BRD-017", barcode: "0490112340178",
    ...
    rating: 4.2, reviews: 690, art: "bread", hue: 35,
    tags: ["essential"],
  ...
  p({
    id: "gs-1018", sku: "GRO-PAN-018", barcode: "0490112340185",
    ...
    rating: 4.0, reviews: 1520, art: "soup", hue: 30,
  ...
  p({
    id: "gs-1019", sku: "GRO-FRZ-019", barcode: "0490112340192",
    ...
    rating: 4.7, reviews: 1340, art: "iceCream", hue: 300,
    tags: ["frozen"],
  ...
  // ---- Automotive ---------------------------------------------------------
  p({
    id: "gs-1020", sku: "AUT-OIL-020", barcode: "0490112340208",
    ...
    rating: 4.7, reviews: 2140, art: "oil", hue: 200,
    tags: ["bulk"],
  ...
  p({
    id: "gs-1021", sku: "AUT-WIP-021", barcode: "0490112340215",
    ...
    rating: 4.3, reviews: 880, art: "wiper", hue: 210,
    tags: [],
  ...
  p({
    id: "gs-1022", sku: "AUT-FLD-022", barcode: "0490112340222",
    ...
    rating: 4.4, reviews: 610, art: "coolant", hue: 195,
    tags: [],
  ...
  p({
    id: "gs-1024", sku: "AUT-ACC-024", barcode: "0490112340246",
    ...
    rating: 4.2, reviews: 2010, art: "airFreshener", hue: 250,
    tags: ["impulse"],
  ...
  // ---- Household ----------------------------------------------------------
  p({
    id: "gs-1025", sku: "HOU-CLN-025", barcode: "0490112340253",
    ...
    rating: 4.4, reviews: 720, art: "cleaner", hue: 165,
    tags: [],
  ...
  p({
    ...
    rating: 4.5, reviews: 1180, art: "paperTowel", hue: 150,
    tags: ["bulk"],
  ...
  p({
    id: "gs-1027", sku: "HOU-BAT-027", barcode: "0490112340277",
    ...
    rating: 4.6, reviews: 1560, art: "battery", hue: 55,
    tags: ["essential"],
  ...
  p({
    id: "gs-1028", sku: "HOU-DET-028", barcode: "0490112340284",
    ...
    rating: 4.3, reviews: 830, art: "detergent", hue: 210,
    tags: [],
  ...
  // ---- Medicine -----------------------------------------------------------
  p({
    id: "gs-1029", sku: "MED-PAI-029", barcode: "0490112340291",
    ...
    rating: 4.6, reviews: 1410, art: "pills", hue: 190,
    tags: ["otc"],
  ...
  p({
    id: "gs-1030", sku: "MED-FST-030", barcode: "0490112340307",
    ...
    rating: 4.5, reviews: 640, art: "bandage", hue: 210,
    tags: ["otc"],
  ...
  p({
    ...
    rating: 4.4, reviews: 980, art: "sanitizer", hue: 175,
    tags: ["otc"],
  ...
  p({
    id: "gs-1032", sku: "MED-PER-032", barcode: "0490112340321",
    ...
    rating: 4.2, reviews: 410, art: "toothpaste", hue: 180,
    tags: ["travel"],
  ...
  p({
    id: "gs-1033", sku: "TOB-CIG-033", barcode: "0490112340338",
    ...
    rating: 3.9, reviews: 240, art: "cigarettes", hue: 15,
    ageRestricted: true,
  ...
  p({
    id: "gs-1034", sku: "TOB-LTR-034", barcode: "0490112340345",
    ...
    rating: 4.1, reviews: 520, art: "lighter", hue: 10,
    ageRestricted: true,
  ...
  // ---- Pet supplies -------------------------------------------------------
  p({
    id: "gs-1035", sku: "PET-FUD-035", barcode: "0490112340352",
    ...
    rating: 4.5, reviews: 780, art: "petFood", hue: 100,
    tags: ["bulk"],
  ...
  p({
    id: "gs-1036", sku: "PET-TRT-036", barcode: "0490112340369",
    ...
    rating: 4.6, reviews: 1090, art: "petTreat", hue: 85,
    tags: [],
